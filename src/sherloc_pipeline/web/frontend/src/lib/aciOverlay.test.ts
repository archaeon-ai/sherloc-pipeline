// Helper-boundary coverage for AciViewer's option-building path.
// Pure-renderer tests can't catch a regression where AciViewer drops
// the scale-bar wiring (the `if (aciImage)` gate
