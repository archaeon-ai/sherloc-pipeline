...
// (regression guard for issue #21; see spec). Adds nav-level behavioral
// coverage — the existing pytest suite proves `/api/config` returns the
// right `features.pds_browser` boolean but not that the SPA actually
// hides the button on it.
